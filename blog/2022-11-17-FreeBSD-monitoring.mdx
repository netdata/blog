...
Another example is networking related metrics, which you can visualize at a high fidelity that might help you to quickly identify the root cause of any unexpexted packet discards.
...
Netdata also automatically discovers hundreds of processes and visualizes them in the Applications section. If your custom application isn't on the list that Netdata recognizes it will show up under "other" but it's just a matter of adding a couple of lines of configuration to make sure it shows up as a separate entry. To find out how to do this, please read our blog on how to find out [which application is causing system load](https://blog.netdata.cloud/server-load/)
