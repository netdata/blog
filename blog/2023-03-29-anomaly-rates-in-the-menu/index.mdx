---
slug: anomaly-rates-in-the-menu
title: "Anomaly Rates in the Menu!"
description: "The menu shows the maximum chart anomaly rate for the visible window or a highlighted time range within each section on the overview or single node tab."
image: ./img/img.png
...
<ReactPlayer controls width='100%' url='https://www.youtube.com/embed/PgVh_MFHMb0'/>
