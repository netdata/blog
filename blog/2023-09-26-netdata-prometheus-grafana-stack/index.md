---
slug: netdata-prometheus-grafana-stack
title: "Netdata, Prometheus, Grafana Stack"
authors: satya
tags: [prometheus, exporter, grafana, netdata, monitoring-stack]
keywords: [prometheus, exporter, grafana, netdata, monitoring-stack]
...
with docker in an ad-hoc way, launching containers that run `/bin/bash` and attaching a TTY to them. We use docker here
