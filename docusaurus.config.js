    ...
    [
      ...
      ({
        ...
        blog: {
          ...
          blogDescription:
            "Home of the Netdata blog about monitoring and troubleshooting.",
  ...
  themeConfig:
    ...
    ({
      ...
      metadata: [
        {
          name: "keywords",
          content: "netdata, monitoring, troubleshooting, servers",
        },
      ],
      navbar: {
        title: "",
        ...
        items: [
          ...
          },
          {
            type: "html",
            position: "left",
            value: '<script src="https://cse.google.com/cse.js?cx=e2e7646659949450a"></script><div class="gcse-search"></div>',
          },
          {
            to: "https://app.netdata.cloud/",
            label: "Sign In",
